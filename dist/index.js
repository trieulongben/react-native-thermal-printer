...
var BLEPrinter = {
    ...
    printText: function (text, opts) {
        ...
        if (Platform.OS === "ios") {
            ...
            return RNBLEPrinter.printRawData(processedText.text, processedText.opts, function (error) { return throwError(error); });
        }
        else {
    ...
    printImage: function (imgUrl, opts) {
        ...
        if (Platform.OS === "ios") {
            ...
            RNBLEPrinter.printImageData(imgUrl, (_a = opts === null || opts === void 0 ? void 0 : opts.imageWidth) !== null && _a !== void 0 ? _a : 0, (_b = opts === null || opts === void 0 ? void 0 : opts.imageHeight) !== null && _b !== void 0 ? _b : 0, function (error) { return throwError(error); });
        }
    },
    /**
     * base 64 string
    ...
    printImageBase64: function (Base64, opts) {
        ...
        if (Platform.OS === "ios") {
             ...
             * just development
             */
            RNBLEPrinter.printImageBase64(Base64, (_a = opts === null || opts === void 0 ? void 0 : opts.imageWidth) !== null && _a !== void 0 ? _a : 0, (_b = opts === null || opts === void 0 ? void 0 : opts.imageHeight) !== null && _b !== void 0 ? _b : 0, function (error) { return throwError(error); });
        }
    },
    /**
     * android print with encoder
    ...
    printRaw: function (text) {
        if (Platform.OS === "ios") {
            var processedText = textPreprocessingIOS(text, false, false);
            return RNBLEPrinter.printRawData(processedText.text, processedText.opts, function (error) {
                return throwError(error);
            });
        }
        else {
            return RNBLEPrinter.printRawData(text, function (error) { return throwError(error); });
        }
    },
    /**
     * `columnWidth`
    ...
    printColumnsText: function (texts, columnWidth, columnAlignment, columnStyle, opts) {
        ...
        if (Platform.OS === "ios") {
            ...
            RNBLEPrinter.printRawData(processedText.text, processedText.opts, function (error) { return throwError(error); });
        }
        else {
...
var NetPrinter = {
    ...
    printText: function (text, opts) {
        ...
        if (Platform.OS === "ios") {
            var processedText = textPreprocessingIOS(text, false, false);
            RNNetPrinter.printRawData(processedText.text, processedText.opts, function (error) { return throwError(error); });
        }
        else {
    ...
    printImage: function (imgUrl, opts) {
        ...
        if (Platform.OS === "ios") {
            ...
            RNNetPrinter.printImageData(imgUrl, (_a = opts === null || opts === void 0 ? void 0 : opts.imageWidth) !== null && _a !== void 0 ? _a : 0, (_b = opts === null || opts === void 0 ? void 0 : opts.imageHeight) !== null && _b !== void 0 ? _b : 0, function (error) { return throwError(error); });
        }
    },
    /**
     * base 64 string
    ...
    printImageBase64: function (Base64, opts) {
        ...
        if (Platform.OS === "ios") {
            ...
            RNNetPrinter.printImageBase64(Base64, (_a = opts === null || opts === void 0 ? void 0 : opts.imageWidth) !== null && _a !== void 0 ? _a : 0, (_b = opts === null || opts === void 0 ? void 0 : opts.imageHeight) !== null && _b !== void 0 ? _b : 0, function (error) { return throwError(error); });
        }
    },
    /**
     * Android print with encoder
    ...
    printRaw: function (text) {
        if (Platform.OS === "ios") {
            ...
            RNNetPrinter.printRawData(text, function (error) { return throwError(error); });
        }
    },
    /**
     * `columnWidth`
